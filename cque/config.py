...
MAZE_ENV_IDS = {'d4rl:maze2d-umaze-v1': {'wandb_run_path': 'koulanurag/cque/3vlh61v7',
                ...
                'd4rl:maze2d-medium-v1': {'wandb_run_path': 'koulanurag/cque/1bftjoon',
                ...
                'd4rl:maze2d-large-v1': {'wandb_run_path': 'koulanurag/cque/15dsw1qk',
                ...
                'd4rl:maze2d-open-v0': {'wandb_run_path': 'koulanurag/cque/19tc4znp',
...
MUJOCO_ENV_IDS = {'HalfCheetah-v2': {'wandb_run_path': 'koulanurag/cque/yc4lqlea',
                                     'datasets': {'random': {'name': 'd4rl:halfcheetah-random-v2', 'split': None},
                                                  ...
                                                  'medium-expert': {'name': 'd4rl:halfcheetah-medium-expert-v2',
                                                                    'split': None}}},
                  'Walker2d-v2': {'wandb_run_path': 'koulanurag/cque/u90g699g',
                                  'datasets': {'random': {'name': 'd4rl:walker2d-random-v2', 'split': None},
                                               ...
                                               'medium-expert': {'name': 'd4rl:walker2d-medium-expert-v2',
                                                                 'split': None}}},
                  'Hopper-v2': {'wandb_run_path': 'koulanurag/cque/2cf737e7',
