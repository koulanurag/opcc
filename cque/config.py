...
MAZE_ENV_IDS = {'d4rl:maze2d-large-v1': {'wandb_run_path': 'koulanurag/cque/6q0o58xp',
                ...
                'd4rl:maze2d-open-v0': {'wandb_run_path': 'koulanurag/cque/3uhrzexg',
                ...
                'd4rl:maze2d-medium-v1': {'wandb_run_path': 'koulanurag/cque/354ubjx8',
                ...
                'd4rl:maze2d-umaze-v1': {'wandb_run_path': 'koulanurag/cque/v72123gt',
...
MUJOCO_ENV_IDS = {'Walker2d-v2': {'wandb_run_path': 'koulanurag/cque/revfitcj',
                                  'datasets': {'random': {'name': 'd4rl:walker2d-random-v2', 'split': None},
                                               ...
                                               'medium-expert': {'name': 'd4rl:walker2d-medium-expert-v2',
                                                                 'split': None}}},
                  'Hopper-v2': {'wandb_run_path': 'koulanurag/cque/3jqt25xf',
                  ...
                  'HalfCheetah-v2': {'wandb_run_path': 'koulanurag/cque/2jkalk1j',
