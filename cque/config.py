...
MAZE_ENV_IDS = {'d4rl:maze2d-umaze-v1': {'wandb_run_path': 'koulanurag/cque/33bhoifl',
                ...
                'd4rl:maze2d-medium-v1': {'wandb_run_path': 'koulanurag/cque/2osvzocb',
                ...
                'd4rl:maze2d-open-v0': {'wandb_run_path': 'koulanurag/cque/1fj9b8n7',
                ...
                'd4rl:maze2d-large-v1': {'wandb_run_path': 'koulanurag/cque/119su6ff',
...
MUJOCO_ENV_IDS = {'HalfCheetah-v2': {'wandb_run_path': 'koulanurag/cque/n3thim8m',
                                     'datasets': {'random': {'name': 'd4rl:halfcheetah-random-v2', 'split': None},
                                                  ...
                                                  'medium-expert': {'name': 'd4rl:halfcheetah-medium-expert-v2',
                                                                    'split': None}}},
                  'Hopper-v2': {'wandb_run_path': 'koulanurag/cque/387mvs7s',
                  ...
                  'Walker2d-v2': {'wandb_run_path': 'koulanurag/cque/29ntrhnd',
