...
MAZE_ENV_IDS = {'d4rl:maze2d-large-dense-v1': {'wandb_run_path': 'koulanurag/cque/he4yv2h0',
                                               'datasets': {'1k': {'name': 'd4rl:maze2d-large-dense-v1', 'split': 1000},
                                                            '10k': {'name': 'd4rl:maze2d-large-dense-v1',
                                                                    'split': 10000},
                                                            '100k': {'name': 'd4rl:maze2d-large-dense-v1',
                                                                     'split': 100000}}},
                'd4rl:maze2d-umaze-dense-v1': {'wandb_run_path': 'koulanurag/cque/f40g080s',
                                               'datasets': {'1k': {'name': 'd4rl:maze2d-umaze-dense-v1', 'split': 1000},
                                                            '10k': {'name': 'd4rl:maze2d-umaze-dense-v1',
                                                                    'split': 10000},
                                                            '100k': {'name': 'd4rl:maze2d-umaze-dense-v1',
                                                                     'split': 100000}}},
                'd4rl:maze2d-medium-dense-v1': {'wandb_run_path': 'koulanurag/cque/a785xl9c', 'datasets': {
                    '1k': {'name': 'd4rl:maze2d-medium-dense-v1', 'split': 1000},
                    '10k': {'name': 'd4rl:maze2d-medium-dense-v1', 'split': 10000},
                    '100k': {'name': 'd4rl:maze2d-medium-dense-v1', 'split': 100000}}},
                'd4rl:maze2d-open-dense-v0': {'wandb_run_path': 'koulanurag/cque/2k0yb0re',
                                              'datasets': {'1k': {'name': 'd4rl:maze2d-open-dense-v0', 'split': 1000},
                                                           '10k': {'name': 'd4rl:maze2d-open-dense-v0', 'split': 10000},
                                                           '100k': {'name': 'd4rl:maze2d-open-dense-v0',
                                                                    'split': 100000}}},
                'd4rl:maze2d-large-v1': {'wandb_run_path': 'koulanurag/cque/3eq8ksp6',
                ...
                'd4rl:maze2d-umaze-v1': {'wandb_run_path': 'koulanurag/cque/1hzsyjpw',
                ...
                'd4rl:maze2d-open-v0': {'wandb_run_path': 'koulanurag/cque/1clfr97o',
                ...
                'd4rl:maze2d-medium-v1': {'wandb_run_path': 'koulanurag/cque/26pb154e',
...
MUJOCO_ENV_IDS = {'Walker2d-v2': {'wandb_run_path': 'koulanurag/cque/3dkrvkvx',
                                  'datasets': {'random': {'name': 'd4rl:walker2d-random-v2', 'split': None},
                                               ...
                                               'medium-expert': {'name': 'd4rl:walker2d-medium-expert-v2',
                                                                 'split': None}}},
                  'Hopper-v2': {'wandb_run_path': 'koulanurag/cque/1yvtod7f',
                  ...
                  'HalfCheetah-v2': {'wandb_run_path': 'koulanurag/cque/2misv05h',
