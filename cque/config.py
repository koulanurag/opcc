...
MAZE_ENV_IDS = {'d4rl:maze2d-umaze-v1': {'wandb_run_path': 'koulanurag/cque/67h9jtdt',
                ...
                'd4rl:maze2d-medium-v1': {'wandb_run_path': 'koulanurag/cque/2a89clfg',
                ...
                'd4rl:maze2d-open-v0': {'wandb_run_path': 'koulanurag/cque/2jafc58a',
                ...
                'd4rl:maze2d-large-v1': {'wandb_run_path': 'koulanurag/cque/2ruj7m4x',
...
MUJOCO_ENV_IDS = {'HalfCheetah-v2': {'wandb_run_path': 'koulanurag/cque/3vs9ct3b',
                                     'datasets': {'random': {'name': 'd4rl:halfcheetah-random-v2', 'split': None},
                                                  ...
                                                  'medium-expert': {'name': 'd4rl:halfcheetah-medium-expert-v2',
                                                                    'split': None}}},
                  'Walker2d-v2': {'wandb_run_path': 'koulanurag/cque/2p1gpg7l',
                                  'datasets': {'random': {'name': 'd4rl:walker2d-random-v2', 'split': None},
                                               ...
                                               'medium-expert': {'name': 'd4rl:walker2d-medium-expert-v2',
                                                                 'split': None}}},
                  'Hopper-v2': {'wandb_run_path': 'koulanurag/cque/2agy42nf',
