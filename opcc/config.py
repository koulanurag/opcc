MAZE_ENV_CONFIGS = {'d4rl:maze2d-umaze-v1': {'datasets': {'1k': {'name': 'd4rl:maze2d-umaze-v1', 'split': 1000},
                                                          '10k': {'name': 'd4rl:maze2d-umaze-v1', 'split': 10000},
                                                          '100k': {'name': 'd4rl:maze2d-umaze-v1', 'split': 100000}}},
                    'd4rl:maze2d-medium-v1': {'datasets': {'1k': {'name': 'd4rl:maze2d-medium-v1', 'split': 1000},
                                                           '10k': {'name': 'd4rl:maze2d-medium-v1', 'split': 10000},
                                                           '100k': {'name': 'd4rl:maze2d-medium-v1', 'split': 100000}}},
                    'd4rl:maze2d-large-v1': {'datasets': {'1k': {'name': 'd4rl:maze2d-large-v1', 'split': 1000},
                                                          '10k': {'name': 'd4rl:maze2d-large-v1', 'split': 10000},
                                                          '100k': {'name': 'd4rl:maze2d-large-v1', 'split': 100000}}},
                    'd4rl:maze2d-open-v0': {'datasets': {'1k': {'name': 'd4rl:maze2d-open-v0', 'split': 1000},
                                                         '10k': {'name': 'd4rl:maze2d-open-v0', 'split': 10000},
                                                         '100k': {'name': 'd4rl:maze2d-open-v0', 'split': 100000}}}}

MUJOCO_ENV_CONFIGS = {'Walker2d-v2': {'datasets': {'random': {'name': 'd4rl:walker2d-random-v2', 'split': None},
                                                   ...
                                                   'medium-expert': {'name': 'd4rl:walker2d-medium-expert-v2',
                                                                     'split': None}}},
                      'Hopper-v2': {'datasets': {'random': {'name': 'd4rl:hopper-random-v2', 'split': None},
                      ...
                      'HalfCheetah-v2': {'datasets': {'random': {'name': 'd4rl:halfcheetah-random-v2', 'split': None},
...
ENV_IDS = {**MAZE_ENV_CONFIGS, **MUJOCO_ENV_CONFIGS}
