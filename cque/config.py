...
MAZE_ENV_IDS = {'d4rl:maze2d-umaze-v1': {'wandb_run_path': 'koulanurag/cque/3pqaeji4',
                ...
                'd4rl:maze2d-medium-v1': {'wandb_run_path': 'koulanurag/cque/2m5or99m',
                ...
                'd4rl:maze2d-open-v0': {'wandb_run_path': 'koulanurag/cque/270fzjmb',
                ...
                'd4rl:maze2d-large-v1': {'wandb_run_path': 'koulanurag/cque/11qr8md7',
...
MUJOCO_ENV_IDS = {'Walker2d-v2': {'wandb_run_path': 'koulanurag/cque/1cevgqgc',
                                  'datasets': {'random': {'name': 'd4rl:walker2d-random-v2', 'split': None},
                                               ...
                                               'medium-expert': {'name': 'd4rl:walker2d-medium-expert-v2',
                                                                 'split': None}}},
                  'Hopper-v2': {'wandb_run_path': 'koulanurag/cque/1c28hepl',
                  ...
                  'HalfCheetah-v2': {'wandb_run_path': 'koulanurag/cque/ki0hdjru',
