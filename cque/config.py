...
MAZE_ENV_IDS = {'d4rl:maze2d-umaze-v1': {'wandb_run_path': 'koulanurag/cque/373o45fe',
                ...
                'd4rl:maze2d-medium-v1': {'wandb_run_path': 'koulanurag/cque/257j3y39',
                ...
                'd4rl:maze2d-large-v1': {'wandb_run_path': 'koulanurag/cque/2pjvxbh7',
                ...
                'd4rl:maze2d-open-v0': {'wandb_run_path': 'koulanurag/cque/25uyviaz',
...
MUJOCO_ENV_IDS = {'Walker2d-v2': {'wandb_run_path': 'koulanurag/cque/3jvtfl6z',
                                  'datasets': {'random': {'name': 'd4rl:walker2d-random-v2', 'split': None},
                                               ...
                                               'medium-expert': {'name': 'd4rl:walker2d-medium-expert-v2',
                                                                 'split': None}}},
                  'Hopper-v2': {'wandb_run_path': 'koulanurag/cque/2o129ahx',
                  ...
                  'HalfCheetah-v2': {'wandb_run_path': 'koulanurag/cque/29oqmxee',
